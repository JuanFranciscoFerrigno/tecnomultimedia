class Aventura {
  ...
  dibujar() {
    ...
    this.imagen[0].resize(1511, 750)
    this.imagen[1].resize(1511, 750)
    this.imagen[2].resize(1511, 750)
    this.imagen[3].resize(1511, 750)
    this.imagen[4].resize(1511, 750)
    this.imagen[5].resize(1511, 750)
    this.imagen[6].resize(1511, 750)
    this.imagen[7].resize(1511, 750)
    this.imagen[8].resize(1511, 750)
    this.imagen[9].resize(1511, 750)
    this.imagen[10].resize(1511, 750)
    this.imagen[11].resize(1511, 750)
